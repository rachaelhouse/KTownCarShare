<nav class="navbar navbar-default navbar-static-top" id="navbar_freshsight">
  <body style="background-color: #819bb2; border: 1px grey; margin: 20px;">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li class=""><a href="./registration.php" class="navbar-item" style="background-color: #dcdfe1;">Register</a></li>
        ...
        <li class=""><a href="./comment.php" class="navbar-item" style="background-color: #dcdfe1;">Comments</a></li>
         <li class=""><a href="./login.php" class="navbar-item" style="background-color: #dcdfe1;">Login</a></li>
